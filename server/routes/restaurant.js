...
import { cancelEvent, createEvent, getAllEvents, getEvent, updateEvent } from '../controller/event.js'
...
restaurantRouter.route('/:id').get(getSingleRestaurant).patch(updateRestaurant).delete(deleteRestaurant)
 ...
 restaurantRouter.route('/:id/event/:eventId').get(getEvent).patch(updateEvent).delete(cancelEvent)
